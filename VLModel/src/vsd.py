...
from caption_data import get_vsd_loader
    ...
    def train(self):
        ...
        for epoch in range(epochs):
            ...
            if self.verbose:
                ...
                valid_score = valid_results['SPICE']
                ...
                log_str += "\nEpoch %d: Valid SPICE %0.4f" % (epoch, valid_score)
                log_str += "\nEpoch %d: Best SPICE %0.4f\n" % (best_epoch, best_valid)
...
def main_worker(gpu, args):
    ...
    trainer = Trainer(args, train_loader, val_loader, val_loader, train=True)
    trainer.train()
